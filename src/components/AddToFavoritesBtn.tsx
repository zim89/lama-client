...
export default function AddToFavoritesBtn({ styles }: { styles?: string }) {
  return (
    <button
      className={cn(
        'flex h-8 w-8 items-center justify-center rounded-full bg-white text-accent-500 transition-all duration-300 hover:text-accent-700 lg:opacity-0 lg:group-hover:opacity-100',
        styles
      )}
    >
      <svg
